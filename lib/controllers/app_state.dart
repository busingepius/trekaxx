...
import 'package:trekax/models/driver.dart';
import 'package:trekax/models/ride_Request.dart';
import 'package:trekax/models/route.dart';
import 'package:trekax/models/user.dart';
import 'package:trekax/services/drivers.dart';
import 'package:trekax/services/map_requests.dart';
import 'package:trekax/services/ride_requests.dart';
import 'package:trekax/widgets/custom_btn.dart';
...
import 'package:trekax/widgets/stars.dart';
import 'package:uuid/uuid.dart';

// TODO: THIS ENUM WILL CONTAIN THE DRAGGABLE WIDGET TO BE DISPLAYED ON THE MAIN SCREEN
// enum Show {
...
class AppStateProvider extends GetxController {
  ...
  //TODO:  Driver request related variables
...
// ANCHOR: MAPS & LOCATION METHODS
  ...
  onCameraMove(CameraPosition position) {
    //TODO:  MOVE the pickup marker only when selecting the pickup location
    if (show.value == 'PICKUP_SELECTION') {
...
// TODO:   this code will ensure that when the driver markers are updated the location marker won't be deleted
...
// TODO:   here we are updating the drivers markers
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      CustomText(text: driverModel?.name ?? "Pius"),
                    ],
                  ),
                  SizedBox(height: 10),
...
//      await placesService.getAutocomplete(searchTerm).then((value) => searchResults = value);
//   }
